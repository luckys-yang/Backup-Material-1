...
#define OLED_CS_Clr()  GPIO_ResetBits(GPIOB,GPIO_Pin_5)//CS1
#define OLED_CS_Set()  GPIO_SetBits(GPIOB,GPIO_Pin_5)
 		     
#define OLED_READ_FS0()    GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_4)//FS0

#define OLED_ROM_CS_Clr()  GPIO_ResetBits(GPIOB,GPIO_Pin_6)//CS2
#define OLED_ROM_CS_Set()  GPIO_SetBits(GPIOB,GPIO_Pin_6)
